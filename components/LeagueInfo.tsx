  ...
  const points = [
    {
      icon: Users,
      title: "Who can join",
      text: "Open to ages 18–44 — students, young professionals, freelancers, families, hobby gamers and strategy enthusiasts. Beginners are just as welcome as seasoned players.",
    },
    {
      icon: Calendar,
      title: "Event format",
